...
Bev.Query = Bev.Class({
    ...
    initialize: function(options) {
        ...
        Bev.loader.js("demo/js/ui/jquery.ui.bevbutton.js",function(){
            t.create();
        });
    },
    ...
    createPopup:function(feature,row,columnTitles){
        ...
        var icon = new SuperMap.Icon("demo/img/marker.png", size, offset);
    ...
    createMarker:function(feature){
        ...
        var size = new SuperMap.Size(24, 34),
            ...
            icon = new SuperMap.Icon("demo/img/marker.png", size, offset);
...
//                console.log("out"+this.bev_index);
    ...
    markerFocus:function(marker){
        ...
        var size = new SuperMap.Size(24, 34),
            offset = new SuperMap.Pixel(-(size.w/2), -size.h),
            icon = new SuperMap.Icon("demo/img/marker1.png", size, offset);
    ...
    createTable:function(fs){
        ...
        if(!this.dataTable){
            Bev.loader.js(["demo/js/controls/DataTable.js"],function(data,columnTitles){
                return function(){
