 ...
 * Examples:
 * (code)
 * Bev.loader.js("demo/js/controls/DataTable.js",function(){
...
Bev.DataTable = Bev.Class({
    ...
    initialize: function(options) {
        ...
        Bev.loader.css("demo/css/demo_table_jui.css");
...
//                            }
    ...
    loadFiles:function(cb){
        ...
        if(!this.isFilesLoaded){
            Bev.loader.js("demo/js/ui/jquery.dataTables.js",function(cb){
